...
namespace Pigmeo.MCU {
	public static partial class Registers {
		...
		public static class STATUS {
			/// <summary>Register Bank Select bit (used for indirect addressing). IRP=false for bank 0 or 1, IRP=true for bank 2 or 3</summary>
			[AsmName("IRP"), Location(true)]
			public volatile static bool IRP = false;

			/// <summary>Register Bank Select bit (used for direct addressing). RP1=false for bank 0 or 1, RP0=true for bank 2 or 3</summary>
			[AsmName("RP1"), Location(true)]
			public volatile static bool RP1 = false;
