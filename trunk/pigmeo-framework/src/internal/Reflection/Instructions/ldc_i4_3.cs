...
namespace Pigmeo.Internal.Reflection {
	public static partial class Instructions {
		...
		public class ldc_i4_3:ldc_i4 {
			public static new ldc_i4_3 GetFromCecilInstruction(Method OriginalMethod, MCCil.Instruction OriginalInstr) {
				return new ldc_i4_3(OriginalMethod, OriginalInstr);
			}
